...
df = pd.read_sql_table(table, input_engine)
...
upload['address line 1'] = df['street_name']
upload['address line 3'] = df['suburb']
upload['address line 4'] = df['state']
upload['postcode'] = df['postcode']
upload['date of birth'] = df['date of birth']
upload['mobile_number'] = df['mobile_nr']
upload['ip_address'] = df['ipaddress']
...
upload['date of birth']=pd.to_datetime(upload['date of birth'])
