...
file1 = 'ORG23571_33357_12092019_Resupply.csv'
file2 = 'tpl_120919.all_data_flag.csv'


#Start processing
df2 = pd.read_csv(onedrive + file2)
...
to_dropremove = ['URN', 'Title', 'Forename', 'Surname', 'Address1', 'Address2', 'Address3',\
'Town', 'County', 'Postcode',  'Postal_Area', 'Postal_District', 'Supplier',\
'list_id', 'source_url', 'title', 'first_name', 'last_name', 'id', 'email', 'optin_date',\
...
'list_id', 'source_url', 'title', 'first_name', 'last_name', 'id', 'email', 'optin_date', 'is_duplicate', 'is_ok', \
...
df.to_csv(directory + "resupplytpl_" + month + ".csv", index=False)