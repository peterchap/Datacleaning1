...
def process_hits(hits):
    for item in hits:
        ...
        return(a)
#
data = es.search(index="logs", scroll="1m",body={	
          "from" : 0, "size" : 9999,   
	  "query" : {
	  "bool":{
	    "must": [
	      {"match" :{"m_Staus": "BOUNCED DEFERED"}}
	      ],
	   #"must_not": [
...
print (df_lst.shape)
df_lst.to_csv(directory + "MainMTAs_Delivery_241019.csv", index=False)
#print (data['hits'][1])
#print(df)
