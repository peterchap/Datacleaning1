...
data = es.search(index="logs*", scroll="2m",body={	
	  ...
	  "bool":{
	    "must": [
	      ...
	      {"match" :{"m_CampaignId": "OemPro-1092" "OemPro-1093" "OemPro-1100" "OemPro-1101" }}
	      ],
	   #"must_not": [
...
print (df_lst.shape)
df_lst.to_csv(directory + "NewMTA_delivery_081019.csv", index=False)
#print (data['hits'][1])
#print(df)
